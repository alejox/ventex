        ...
        <div id="inicio" className="relative mx-auto grid w-full max-w-7xl gap-8 px-5 pt-8 pb-16 sm:px-8 lg:grid-cols-[1.05fr_.95fr] lg:items-end lg:py-20">
          <div>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              {site.bookingEnabled ? <a href="#reservar" className="inline-flex min-h-12 items-center rounded-full bg-[var(--site-accent)] px-6 text-sm font-extrabold text-[var(--site-on-accent)] transition-transform hover:-translate-y-0.5">Elegir un horario</a> : null}
              {site.services.length ? <a href="#servicios" className="inline-flex min-h-12 items-center rounded-full bg-[var(--site-surface)] px-6 text-sm font-bold">Explorar servicios</a> : null}
            </div>
          ...
          <div className="relative min-h-80 overflow-hidden rounded-[var(--site-radius)] border border-[var(--site-border)] bg-[var(--site-surface)] shadow-[var(--site-shadow)] sm:min-h-[34rem]">
