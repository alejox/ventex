...
export function IconHelpCircle(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24" width="20" height="20" {...props}>
      <circle cx="12" cy="12" r="10" />
...
export function IconTrendingDown(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24" width="20" height="20" {...props}>
...
export function IconBank(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24" width="20" height="20" {...props}>
      <polygon points="12 2 2 7 22 7 12 2" />
      <line x1="2" y1="22" x2="22" y2="22" />
      <line x1="2" y1="18" x2="22" y2="18" />
      <line x1="4" y1="18" x2="4" y2="11" />
...
export function IconUserBadge(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24" width="20" height="20" {...props}>
...
export function IconImagePlaceholder(props: React.SVGProps<SVGSVGElement>) {
  return (
...
export function IconThunder(props: React.SVGProps<SVGSVGElement>) {
  return (
...
export function IconMusic(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24" width="20" height="20" {...props}>
