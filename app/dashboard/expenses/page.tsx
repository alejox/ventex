      ...
      <div className="flex items-center justify-between gap-4 mb-4">
        <div>
          ...
          <p className="text-xs text-on-surface-variant mt-1">
            Catálogo independiente de las categorías de productos.
          </p>
        </div>
