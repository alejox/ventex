              ...
              {filtered.map((product) => (
                ...
                >
                  ...
                  <div className="flex items-center justify-between mt-auto">
                    <span className="text-on-surface font-bold">${money(product.price)}</span>
                    <span
                ...
                <div className="flex items-center justify-between mt-1">
                  <div className="flex items-center border border-outline-variant/20 rounded-lg overflow-hidden bg-surface-container-lowest">
                    ...
                    <input
                      type="number"
                      min={1}
                      max={line.product.stock_level}
                      value={line.quantity}
                      onChange={(e) => {
                        const v = parseInt(e.target.value, 10);
                        if (Number.isFinite(v)) setQuantity(line.product.id, v);
                      }}
                    ...
                    <button
                      ...
                      disabled={line.quantity >= line.product.stock_level}
