...
export const TEST_EMAIL = process.env.E2E_EMAIL ?? process.env.TEST_EMAIL ?? "test@ventex.com";
export const TEST_PASSWORD = process.env.E2E_PASSWORD ?? process.env.TEST_PASSWORD ?? "Test123!";
