...
- **El canje NO pone el progreso en cero: consume el umbral entregado y el resto arranca el conteo siguiente.** Quien llegó a 11 y canjea uno de 10 queda en 1 — ese corte lo hizo y lo pagó, y ponerlo en cero es cobrarle por haber vuelto antes de pasar por el mostrador. Con varios hitos descuenta el ENTREGADO, no el más bajo: progreso 21 con hitos de 10 y 20 entrega el de 20 y deja 1; descontar 10 dejaría 11 y regalaría un segundo premio al toque. La cuenta autoritativa es `redeem_promo`; `progressAfterRedeem` la espeja (pura, testeada) solo para poder AVISARLO en el modal antes de confirmar.
