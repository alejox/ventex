-- create_sale calcula y congela la comisión de cada línea.
--
-- Único cambio respecto de la versión anterior: la variable v_commission, su
-- cálculo en las dos ramas (servicio y producto) y la columna extra en los dos
-- INSERT de sale_items. La matemática del IVA, el orden de sus ramas, los
-- turnos, el fiado, el stock y los splits quedan EXACTAMENTE igual.
