...
import type { ExpenseCategory, ExpenseInput, ExpensePeriod, ExpenseRecord } from "@/services/expenses.service";
...
export const useExpensesStore = create<ExpensesState>((set, get) => ({
  ...
  period: "month", search: "", categoryId: "",
  fetch: async () => {
    set({ loading: true, error: null });
    try { set({ expenses: await service.listExpenses(get().period, get().search, get().categoryId), loading: false }); }
